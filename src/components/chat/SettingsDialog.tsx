...
export default function SettingsDialog() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[95vw] max-w-[720px] bg-[#0d0d10] border-[var(--border-strong)] text-[var(--text-primary)] max-h-[88vh] overflow-y-auto">
        <DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-[#0d0d10] border-[var(--border-strong)]">
                    <SelectItem value="sm" className="text-xs">Klein (0.85×)</SelectItem>
                    <SelectItem value="md" className="text-xs">Mittel (1×)</SelectItem>
                    <SelectItem value="lg" className="text-xs">Groß (1.2×)</SelectItem>
                    <SelectItem value="xl" className="text-xs">TV/4K (1.4×)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
